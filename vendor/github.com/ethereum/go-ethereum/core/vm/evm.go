...
func (evm *EVM) create(caller ContractRef, codeAndHash *codeAndHash, gas uint64, value *big.Int, address common.Address, typ OpCode) ([]byte, common.Address, uint64, error) {
	...
	if !evm.AddressWhitelisted(caller.Address()) {
		...
		return nil, common.Address{}, gas, fmt.Errorf("deployer address not whitelisted: %s", caller.Address().Hex())
	}
...
func (evm *EVM) AddressWhitelisted(addr common.Address) bool {
	...
	owner := evm.StateDB.GetState(params.DeployerWhiteListAddress, ownerKey)
	...
	isWhitelisted := evm.StateDB.GetState(params.DeployerWhiteListAddress, key)
