...
func (bc *BlockChain) insertChain(chain types.Blocks, verifySeals, setHead bool) (int, error) {
	...
	parentBlockHeader := bc.GetHeaderByHash(parentHash)
	stateReader, err := bc.StateAt(parentBlockHeader.Root)
	if err != nil {
		return 0, err
	}
	SenderCacher.RecoverFromBlocks(types.MakeSigner(bc.chainConfig, chain[0].Number(), stateReader), chain)
...
func (bc *BlockChain) collectLogs(b *types.Block, removed bool) []*types.Log {
	...
	stateReader, _ := bc.StateAt(b.Root())
	receipts.DeriveFields(bc.chainConfig, b.Hash(), b.NumberU64(), b.Time(), b.BaseFee(), b.Transactions(), stateReader)
