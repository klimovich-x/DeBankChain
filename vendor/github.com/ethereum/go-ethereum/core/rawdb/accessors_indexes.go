...
// its added positional metadata.
func ReadReceipt(db ethdb.Reader, hash common.Hash, config *params.ChainConfig, stateReader types.StateReader) (*types.Receipt, common.Hash, uint64, uint64) {
	...
	receipts := ReadReceipts(db, blockHash, *blockNumber, config, stateReader)
